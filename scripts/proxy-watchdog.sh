...
#
# Scheduled by launchd unit com.composer-proxy.watchdog (StartInterval=300).
...
# Confirmed unhealthy: recycle and re-probe once.
log "UNHEALTHY two consecutive probes failed — kickstarting $SERVICE"
launchctl kickstart -k "gui/${UID_NUM}/${SERVICE}" >> "$LOG" 2>&1
